        ...
        <div className="w-[280px] h-full glass glow-border rounded-none border-l-0 border-t-0 border-b-0 flex flex-col p-6">
                    ...
                    {({ isActive }) => {
                      ...
                      return (
                        <motion.div
                          ...
                          className={`w-full flex items-center gap-4 px-4 py-3 rounded-xl mb-2 relative group smooth-transition ${
                            active
                              ? 'glass glow-border shadow-glow-purple bg-white/10'
                              : 'hover:bg-white/5'
                          }`}
                        >
                          <Icon
                          ...
                          <span className="text-sm font-medium text-left text-text-primary">
                            {item.label}
                          </span>
          ...
          >
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-red-500/10 text-red-400 hover:bg-red-500/20 transition-all mb-4"
            >
              <LogOut size={18} />
              Logout
            </button>
